...
<?php
    ...
    function findById($id){
        ...
        $conexao = $conexao->query("SELECT * FROM professor WHERE idprofessor = $id;");
...
<body>
    <div class="row">
        <div class="col-12">
            <form action="acao/acaoProfessor.php" method="post">
                <legend>Cadastrar Professor</legend>
                <div class="row">
                    <div class="col-4"><label for="ID">ID:</label></div>
                    <div class="col-8"><input type="text" name="id" value="<?php if($acao == "editar") echo $dados["idprofessor"]; else echo 0; ?>" readonly></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-4"><label for="materia">Matéria:</label></div>
                    <div class="col-8"><input type="text" name="materia" id="materia" value="<?php if($acao == "editar") echo $dados["materia"]; ?>"></div>
                </div>
                <div class="row">
                    <div class="col-4"></div>
