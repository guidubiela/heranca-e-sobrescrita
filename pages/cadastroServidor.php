...
<?php
    ...
    function findById($id){
        ...
        $conexao = $conexao->query("SELECT * FROM servidor WHERE idservidor = $id;");
...
<body>
    <div class="row">
        <div class="col-12">
            <form action="acao/acaoServidor.php" method="post">
                <legend>Cadastrar Servidor</legend>
                <div class="row">
                    <div class="col-4"><label for="ID">ID:</label></div>
                    <div class="col-8"><input type="text" name="id" value="<?php if($acao == "editar") echo $dados["idservidor"]; else echo 0; ?>" readonly></div>
                </div>
                <div class="row">
